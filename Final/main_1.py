...
matches.drop(['id', 'home_team_api_id', 'away_team_api_id'], axis=1, inplace=True)
...
y = le.fit_transform(matches['match_outcome'])
...
gb_clf = XGBClassifier(n_estimators=500, learning_rate=0.01, max_depth=5, objective='multi:softmax', num_class=3)
